...
## ソースコードの説明
l.24:argcの2番目の文字列をmuに格納

l.25:argcの3番目の文字列をsigmaに格納

l.26:argcの4番目の文字列をnum_dummyに格納

l.40:iがnum_dummy以下の値を取る間、以下の処理を行う

l.42:dummyに標準正規分布に従う0~1の間の一様乱数にsigmaを掛けてmuを足した値を格納

l.43:dummyの値を出力

l.49:関数r_unifの処理を以下の通り実行する

l.54:関数r_stdnormの処理を以下の通り実行する
